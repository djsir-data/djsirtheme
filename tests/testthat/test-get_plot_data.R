...
test_that("get_plot_data() returns plot data passed to ggplot() call", {
    test_plot <-
...
test_that("get_plot_data() defaults to the last plot", {
...
test_that("get_plot_data() supports formulae in aesthetics", {
    test_plot <-
      ggplot(
        iris,
        aes(
...
test_that("get_plot_data() detects aesthetics across multiple layers", {
    test_plot <-
      ggplot(iris, aes(Petal.Length, Petal.Width)) +
...
test_that("get_plot_data() ignores layers that have their own data", {
    test_dataset <-
...
test_that("get_plot_data() preserves row names", {
...
test_that("get_plot_data() exports facet variables", {
...
test_that("get_plot_data() exports patchwork plot data", {
