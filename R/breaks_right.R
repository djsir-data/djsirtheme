...
#'
#' This function generates a vector of 'pretty' breaks
#' (using `scales::breaks_pretty()`) that ends with the upper limit
#' provided and excludes any values that lie outside the limits.
#'
