...
#' @author Matt Cowgill (adapted to fit DJSIR style by Annett Finger)
#' @examples
#'
#' # Here's a basic chart in the DJSIR style:
#' library(ggplot2)
#'
...
djsir_y_continuous <- function(expand_bottom = 0, expand_top = 0.015, ...) {
...
djsir_x_continuous <- function(expand_left = 0,
                               expand_right = 0.015,
                               ...) {
