#' Title Defines DJSIR base theme - function is called by 'theme_djsir' but not exported
#'
...
theme_djsir_base <- function(base_size = 12,
                            base_family = "sans",
  ...
  ret <-
    theme(
      ...
      plot.subtitle = element_text(
        colour = djsirtheme::djsir_cool_grey_11,
        size = rel(.8),
        hjust = 0,
        vjust = 1,
        margin = margin(
